...
{{-- 
  V-- INI DIA PERBAIKANNYA --V
  Kita gabungkan SEMUA logic Alpine.js (TTS & Toast Notifikasi) 
  ke dalam satu x-data di tag <body>
--}}
<body 
    class="antialiased"
    {{-- Kita buat 1 x-data global --}}
    x-data="{
        ...
        initTTS() {
            if ('speechSynthesis' in window) {
                ...
                console.error('TTS tidak didukung.');
            }
        },
        loadVoices() {
    ...
    {{-- Kita panggil initTTS() saat body di-load --}}
    x-init="initTTS()"

    {{-- Ini 2 "telinga" global kita --}}
    ...
    "
>
    {{-- Sekarang $slot adalah "anak" dari body, 100% aman --}}
    {{ $slot }}

    {{-- 
      V-- INI "HUTANG" KITA DARI POS --V
      Container untuk menampilkan Toast Notifikasi.
      Kita letakkan di sini agar global.
    --}}
    ...
    {{-- HAPUS <div x-data...> yang lama dari sini --}}
